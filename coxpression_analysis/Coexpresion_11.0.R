...
Colombos <- read.table("Data/Colombos/colombos_ecoli_exprdata_20151029.txt", sep="\t", header=TRUE, row.names = 1)
...
check <- function(X){  # This function cheks if all the genes of X are in the row names of Colombos data set. The function returns those genes that are in Colombos
